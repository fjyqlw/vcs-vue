                ...
                <template>
                    ...
                    <tree-grid
                        ...
                        <template slot="kind" slot-scope="scope">
                            <span v-if="scope.row.kind=='dir'">文件夹</span>
                            <span v-else>文件</span>
                        </template>
                        <template slot="action" slot-scope="scope">
                            <Button type="primary" @click="edit(scope.row)" size="small">编辑</Button>
                            <Button type="success" @click="onDownload(scope.row)" size="small">导出</Button>

...
export default {
  data() {
    return {
      ...
      columns: [
        { title: "ID", key: "userId", sortable: true },
        ...
        },
        {
          ...
          key: "registerDate",
          render: (h, params) => {
            return h("span", params.row.registerDate);
          },
          sortable: true
        },
        {
          ...
          key: "lastLoginDate",
          render: (h, params) => {
            return h("span", params.row.lastLoginDate);
          },
          sortable: true
        },
        {
          ...
          render: (h, params) => {
            return h("div", [
              h(
                ...
                {
                  props: {
                    type: params.row.state == 1 ? "success" : "warning",
                    size: "small"
                  },
              ...
              h(
                "Button",
                {
                  ...
                  on: {
                    click: () => {
                      this.openAddModal(params.row.userId);
                    }
                  }
                },
                "修改"
      ...
      if (type === 1) {
        this.$refs.table.exportCsv({
          ...
          columns: this.columns.filter(
            (col, index) => index > 1 && index < this.columns.length - 1
          ),
          data: this.data
        });
      }
